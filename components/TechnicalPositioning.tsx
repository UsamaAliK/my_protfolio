      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {tiers.map((tier, index) => {
          ...
          return (
            <div
              key={tier.title}
              className="p-4 rounded-lg bg-[#FBFBF9] dark:bg-[#0B0F1A] border border-[#E8E8E4] dark:border-[#1F2937] hover:border-[#0D9488]/40 transition-colors flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="p-1.5 rounded bg-white dark:bg-[#111827] border border-[#E8E8E4] dark:border-[#1F2937] text-[#0D9488]">
