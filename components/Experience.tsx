        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {experiences.map((exp) => (
              <div
                key={exp.role}
                className="bg-white dark:bg-[#111827] border border-[#E8E8E4] dark:border-[#1F2937] rounded-xl p-6 hover:border-[#0D9488]/40 transition-colors shadow-2xs group"
              >
                <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                  <div>
                    <h4 className="text-base font-bold text-[#111827] dark:text-[#F9FAFB] group-hover:text-[#0D9488] transition-colors">
                      {exp.role}
                    </h4>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white dark:bg-[#111827] border border-[#E8E8E4] dark:border-[#1F2937] rounded-xl p-6 hover:border-[#0D9488]/40 transition-colors shadow-2xs">
              ...
              <h4 className="text-base font-bold text-[#111827] dark:text-[#F9FAFB]">
                {education.degree}
              </h4>
              <p className="text-xs font-semibold text-[#4B5563] dark:text-[#9CA3AF] mt-1">
                {education.institution}
              </p>

              <p className="text-xs text-[#6B7280] dark:text-[#9CA3AF] leading-relaxed mt-4 pt-3 border-t border-[#E8E8E4]/60 dark:border-[#1F2937]/60">
                {education.details}
              </p>
            </div>
          </div>
