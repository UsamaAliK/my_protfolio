...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 sm:py-24 border-b border-[#E8E8E4]/60">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 bg-white border border-[#E8E8E4] rounded-xl p-6 shadow-2xs">
            <div className="flex items-center justify-between pb-3 mb-4 border-b border-[#E8E8E4]">
              <h3 className="text-xs font-mono text-[#111827] uppercase tracking-wider font-semibold">
                Core Specifications
              </h3>
            ...
            <div className="space-y-3.5">
              {profileItems.map((item) => (
                <div key={item.label} className="flex flex-col">
                  ...
                  <span className="text-xs font-medium text-[#111827] mt-0.5">
                    {item.value}
                  </span>
                </div>
              ))}
